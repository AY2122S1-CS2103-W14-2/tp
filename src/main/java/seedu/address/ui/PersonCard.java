...
public class PersonCard extends UiPart<Region> {
    ...
    public HBox getWorkAddressHBox() { return workAddressHBox; }

    public HBox getQuarantineAddressHBox() { return quarantineAddressHBox; }

    public HBox getShnPeriodHBox() { return shnPeriodHBox; }

    public HBox getNextOfKinNameHBox() { return nextOfKinNameHBox; }

    public HBox getNextOfKinPhoneHBox() { return nextOfKinPhoneHBox; }

    public HBox getNextOfKinAddressHBox() { return nextOfKinAddressHBox; }

    public VBox getNextOfKinBlock() { return nextOfKinBlock; }
